...
def settings_payload(
    *,
    ...
    payload = {
        ...
        "voice_input_hands_free_freestyle": settings.voice_input_hands_free_freestyle,
        "voice_input_hands_free_edging": settings.voice_input_hands_free_edging,
        "voice_input_hands_free_milking": settings.voice_input_hands_free_milking,
        "voice_input_hands_free_legacy_auto": settings.voice_input_hands_free_legacy_auto,
        ...
        "allow_llm_freestyle_in_chat": settings.allow_llm_freestyle_in_chat,
        "allow_llm_edging_in_chat": settings.allow_llm_edging_in_chat,
        "allow_llm_milking_in_chat": settings.allow_llm_milking_in_chat,
        "allow_llm_legacy_auto_in_chat": settings.allow_llm_legacy_auto_in_chat,
