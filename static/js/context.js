...
export const el = {
    ...
    promptLibraryDialog: D.getElementById('prompt-library-dialog'),
    openPromptLibraryBtn: D.getElementById('open-prompt-library-btn'),
    closePromptLibraryBtn: D.getElementById('close-prompt-library-btn'),
    promptLibraryList: D.getElementById('prompt-library-list'),
    promptLibraryNewBtn: D.getElementById('prompt-library-new-btn'),
    promptLibraryNameInput: D.getElementById('prompt-library-name-input'),
    promptLibraryKindBadge: D.getElementById('prompt-library-kind-badge'),
    promptLibraryUseBtn: D.getElementById('prompt-library-use-btn'),
    promptLibrarySaveBtn: D.getElementById('prompt-library-save-btn'),
    promptLibraryDuplicateBtn: D.getElementById('prompt-library-duplicate-btn'),
    promptLibraryDeleteBtn: D.getElementById('prompt-library-delete-btn'),
    promptLibraryStatus: D.getElementById('prompt-library-status'),
    promptLibraryActiveStatus: D.getElementById('prompt-library-active-status'),
    ...
    handyBluetoothMenu: D.getElementById('handy-bluetooth-menu'),
    handyBluetoothBtn: D.getElementById('handy-bluetooth-btn'),
    handyBluetoothPopover: D.getElementById('handy-bluetooth-popover'),
    bluetoothMenuState: D.getElementById('bluetooth-menu-state'),
    bluetoothMenuTransport: D.getElementById('bluetooth-menu-transport'),
    bluetoothMenuSupport: D.getElementById('bluetooth-menu-support'),
    bluetoothMenuDevice: D.getElementById('bluetooth-menu-device'),
    bluetoothMenuQueue: D.getElementById('bluetooth-menu-queue'),
    bluetoothMenuMessage: D.getElementById('bluetooth-menu-message'),
    bluetoothMenuActionBtn: D.getElementById('bluetooth-menu-action-btn'),
    bluetoothMenuSettingsBtn: D.getElementById('bluetooth-menu-settings-btn'),
    ...
    voiceInputHandsFreeFreestyleCheckbox: D.getElementById('voice-input-hands-free-freestyle-checkbox'),
    voiceInputHandsFreeEdgingCheckbox: D.getElementById('voice-input-hands-free-edging-checkbox'),
    voiceInputHandsFreeMilkingCheckbox: D.getElementById('voice-input-hands-free-milking-checkbox'),
    voiceInputHandsFreeLegacyAutoCheckbox: D.getElementById('voice-input-hands-free-legacy-auto-checkbox'),
    ...
    handyRestConnectionControls: D.getElementById('handy-rest-connection-controls'),
    ...
    handyTransportSelect: D.getElementById('handy-transport-select'),
    saveHandyTransportBtn: D.getElementById('save-handy-transport-btn'),
    handyTransportStatus: D.getElementById('handy-transport-status'),
    ...
    motionPatternSearchInput: D.getElementById('motion-pattern-search-input'),
    motionPatternStatus: D.getElementById('motion-pattern-status'),
    motionFeedbackHistory: D.getElementById('motion-feedback-history'),
    motionPatternLibraryFreestyleCheckbox: D.getElementById('motion-pattern-library-freestyle-checkbox'),
    motionPatternLibraryChatCheckbox: D.getElementById('motion-pattern-library-chat-checkbox'),
    ...
    allowLlmFreestyleChatCheckbox: D.getElementById('allow-llm-freestyle-chat-checkbox'),
    allowLlmEdgingChatCheckbox: D.getElementById('allow-llm-edging-chat-checkbox'),
    allowLlmMilkingChatCheckbox: D.getElementById('allow-llm-milking-chat-checkbox'),
    allowLlmLegacyAutoChatCheckbox: D.getElementById('allow-llm-legacy-auto-chat-checkbox'),
    ...
    autospeakMotionAutonomySelect: D.getElementById('autospeak-motion-autonomy-select'),
    autospeakMotionAutonomyStatus: D.getElementById('autospeak-motion-autonomy-status'),
    ...
    motionTrainingPatternSearchInput: D.getElementById('motion-training-pattern-search-input'),
    ...
    quickMotionCylinderTrigger: D.getElementById('handy-cylinder-indicator'),
    ...
    quickMotionSpeedMinVal: D.getElementById('quick-motion-speed-min-val'),
    quickMotionSpeedMaxVal: D.getElementById('quick-motion-speed-max-val'),
    quickMotionDepthMin: D.getElementById('quick-motion-depth-min'),
    quickMotionDepthMax: D.getElementById('quick-motion-depth-max'),
    quickMotionDepthMinVal: D.getElementById('quick-motion-depth-min-val'),
    quickMotionDepthMaxVal: D.getElementById('quick-motion-depth-max-val'),
    quickMotionReverseToggle: D.getElementById('quick-motion-reverse-toggle'),
    quickMotionStatus: D.getElementById('quick-motion-status'),
    quickMotionSettingsLink: D.getElementById('quick-motion-settings-link'),
...
export const state = {
    ...
    handyBluetoothPollAbort: null,
    handyBluetoothCommandLoopActive: false,
    handyBluetoothDevice: null,
    handyBluetoothServer: null,
    handyBluetoothTx: null,
    handyBluetoothRx: null,
    handyBluetoothMessageId: 1,
    handyBluetoothPendingResponses: new Map(),
    handyBluetoothClockOffsetMs: 0,
    handyBluetoothMenuOpen: false,
    ...
    motionPatternLibraryEnabledInFreestyle: false,
    motionPatternLibraryEnabledInChat: false,
    allowLlmEdgeInFreestyle: true,
    allowLlmEdgeInChat: true,
    allowLlmModeActionsInChat: false,
    allowLlmFreestyleInChat: false,
    allowLlmEdgingInChat: false,
    allowLlmMilkingInChat: false,
    allowLlmLegacyAutoInChat: false,
    autospeakEnabled: false,
    autospeakMinSeconds: 12,
    autospeakMaxSeconds: 45,
    autospeakMotionAutonomy: 'full',
    autospeakMotionAutonomyOptions: [],
    ...
    voiceInputHandsFreeFreestyle: false,
    voiceInputHandsFreeEdging: false,
    voiceInputHandsFreeMilking: false,
    voiceInputHandsFreeLegacyAuto: false,
    ...
    promptLibrarySets: {},
    promptLibraryRendered: {},
    promptLibrarySampleName: '',
    promptLibrarySelectedMode: '',
    promptLibraryEditingId: '',
    promptLibraryDraftIsNew: false,
    chatModelBlockedMessage: '',
    pendingQueuedBotEcho: '',
    chatStreamingEnabled: true,
    motionPatterns: [],
    motionPrograms: [],
    motionTagSuggestions: [
        'intense',
        'full shaft',
        'mid shaft',
        'tip',
