...
export const el = {
    ...
    topBarBluetoothMenu: D.getElementById('top-bar-bluetooth-menu'),
    topBarBluetoothBtn: D.getElementById('top-bar-bluetooth-btn'),
    topBarBluetoothPopover: D.getElementById('top-bar-bluetooth-popover'),
