...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="profile-about-menu-btn" class="profile-menu-item" type="button" role="menuitem" aria-disabled="true" disabled title="About popup planned">About</button>', page)
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".profile-menu-item:disabled { cursor: default;", css)
