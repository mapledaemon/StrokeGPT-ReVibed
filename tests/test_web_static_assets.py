...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="toggle-sidebar-btn" title="Collapse settings panel" aria-label="Collapse settings panel" aria-expanded="true" aria-controls="sidebar"', page)
            ...
            self.assertIn('id="motion-pattern-library-freestyle-checkbox"', page)
            self.assertIn('id="motion-pattern-library-chat-checkbox"', page)
            ...
            self.assertIn('id="handy-key-status" class="settings-help settings-warning-line">Disconnected</div>', page)
    ...
    def test_settings_dialog_contains_device_and_speed_controls(self):
        ...
        try:
            ...
            self.assertIn('id="allow-llm-freestyle-chat-checkbox"', page)
            self.assertIn('id="allow-llm-edging-chat-checkbox"', page)
            self.assertIn('id="allow-llm-milking-chat-checkbox"', page)
            self.assertIn('id="allow-llm-legacy-auto-chat-checkbox"', page)
            self.assertIn('id="autospeak-min-seconds"', page)
            self.assertIn('id="autospeak-max-seconds"', page)
            self.assertIn('id="autospeak-motion-autonomy-select"', page)
            self.assertIn('id="autospeak-motion-autonomy-status"', page)
            self.assertIn('<option value="full" selected>Full motion</option>', page)
            ...
            self.assertIn('Experimental: use exact pattern-library playback in Freestyle and preset modes', page)
            self.assertIn('Experimental: let normal chat choose exact pattern-library moves', page)
            ...
            self.assertIn('id="export-motion-library-btn"', page)
            ...
            self.assertIn('id="motion-transform-simplify-btn"', page)
            self.assertIn('id="motion-transform-harshen-btn"', page)
            self.assertIn('id="motion-draw-detail-slider"', page)
            self.assertIn('id="motion-draw-detail-value"', page)
            ...
            self.assertIn("<h4>Model Memory</h4>", page)
            self.assertIn('id="long-term-memory-checkbox" data-requires-backend', page)
            self.assertIn("Saved profile memory persists across restarts", page)
            self.assertIn('id="clear-long-term-memory-btn" class="my-button" data-requires-backend', page)
            self.assertIn('id="long-term-memory-status" class="settings-status-line"', page)
            self.assertIn('id="long-term-memory-items" class="memory-item-list"', page)
            self.assertIn('id="long-term-memory-preview" class="diagnostics-output memory-preview-output"', page)
            ...
            self.assertIn('id="voice-input-hands-free-freestyle-checkbox" data-requires-backend', page)
            self.assertIn('id="voice-input-hands-free-edging-checkbox" data-requires-backend', page)
            self.assertIn('id="voice-input-hands-free-milking-checkbox" data-requires-backend', page)
            self.assertIn('id="voice-input-hands-free-legacy-auto-checkbox" data-requires-backend', page)
    ...
    def test_quick_motion_menu_markup(self):
        ...
        try:
            ...
            # The sidebar Handy cylinder visualizer is the primary quick-settings
            # trigger; the bottom meter panel stays clickable as a fallback for
            # when the sidebar is collapsed or off-canvas on mobile.
            self.assertIn(
                'id="handy-cylinder-indicator" class="quick-motion-cylinder-trigger" role="button" tabindex="0" '
            ...
            # Codex's standalone sliders button was replaced by the cylinder trigger.
            self.assertNotIn('id="quick-motion-trigger-btn"', page)
            self.assertIn(
    ...
    def test_quick_motion_menu_js_wiring(self):
        ...
        self.assertIn("quickMotionCylinderTrigger", scripts)
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".top-bar-actions .top-bar-intensity-guide.is-ramp-up", css)
            ...
            self.assertIn("transition: background-color 0.2s ease; font-size: 1.2em; display: flex; align-items: center; justify-content: center;", css)
            ...
            self.assertIn('grid-template-columns: minmax(0, 1fr) var(--voice-control-width); grid-template-areas: "message voice" "status status";', css)
            self.assertIn("#message-input-line { grid-area: message; width: 100%; min-width: 0; min-height: var(--composer-min-height); margin: 0;", css)
            ...
            self.assertIn("#voice-control-buttons { grid-area: voice; position: relative; width: var(--voice-control-width); min-height: var(--composer-min-height);", css)
            ...
            self.assertIn("#status-text { grid-area: status; width: 100%; min-width: 0; min-height: 2rem; margin: 0;", css)
            ...
            self.assertIn("#message-input-line { grid-area: message; }", css)
            ...
            self.assertIn("--mobile-top-bar-offset: 6.25rem;", css)
            self.assertIn("--mobile-top-bar-offset: 5.75rem;", css)
    ...
    def test_frontend_js_handles_motion_pattern_list_controls(self):
        ...
        self.assertIn("function hspStateCurrentPointDepth", script)
        self.assertIn("hsp-current-point", script)
        self.assertIn("startHandyCylinderAnimation", script)
        ...
        self.assertNotIn("function setHandyCylinderRange", script)
        ...
        self.assertIn("function updateChatSessionTimer", script)
        self.assertIn("chat_elapsed_seconds", script)
        self.assertIn("data.arc || data.chat_arc || data.chat_intensity_guide", script)
        self.assertIn("/set_chat_intensity_guide", script)
        ...
        self.assertIn("/clear_memory", script)
        self.assertIn("/delete_memory_item", script)
        self.assertIn("populateLongTermMemorySetting", script)
        self.assertIn("memory-item-row", script)
        self.assertIn("Clear saved long-term memories and current chat context?", script)
        self.assertIn("Remove this saved memory?", script)
        ...
        self.assertIn("autospeak_motion_autonomy", script)
        self.assertIn("autospeakMotionAutonomySelect", script)
    ...
    def test_motion_pattern_list_module_is_extracted(self):
        ...
        try:
            ...
            self.assertIn("export async function setMotionPatternTags", pattern_list_script)
            ...
            self.assertIn("export function createPatternTagsButton", pattern_list_script)
            ...
            self.assertIn("motion-pattern-tags", pattern_list_script)
            ...
            self.assertIn("/motion_patterns/${encodeURIComponent(patternId)}/tags", pattern_list_script)
            ...
            self.assertIn("/motion_library/export", motion_control_script)
    ...
    def test_motion_feedback_controls_module_is_extracted(self):
        ...
        try:
            ...
            self.assertIn("configureMotionFeedbackControls({renderMotionPatterns, renderMotionStyleOptions})", motion_control_script)
            self.assertIn("Compatibility shim - do not extend", motion_control_script)
            ...
            self.assertIn("export async function resetMotionPreferences", feedback_controls_script)
            self.assertIn("/motion_feedback_options", feedback_controls_script)
            self.assertIn("/motion_preferences/reset", feedback_controls_script)
            self.assertIn("motionFeedbackAutoDisableCheckbox", feedback_controls_script)
            self.assertIn("motionPatternLibraryFreestyleCheckbox", feedback_controls_script)
            self.assertIn("motionPatternLibraryChatCheckbox", feedback_controls_script)
            self.assertIn("Pattern library saved", feedback_controls_script)
    ...
    def test_motion_program_list_module_is_extracted(self):
        ...
        try:
            ...
            self.assertIn("export async function setMotionProgramTags", program_list_script)
            ...
            self.assertIn("/tags", program_list_script)
            ...
            self.assertIn("motion-program-tags", program_list_script)
    ...
    def test_motion_training_editor_module_is_extracted(self):
        ...
        try:
            ...
            self.assertIn("export function simplifyDrawnActions", training_editor_script)
            self.assertIn("export function smoothEditedPattern", training_editor_script)
            self.assertIn("export function simplifyEditedPattern", training_editor_script)
            ...
            self.assertNotIn("function simplifyEditedPattern", motion_control_script)
