...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".model-actions { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr));", css)
            self.assertIn(".model-actions-wide { grid-template-columns: repeat(3, minmax(0, 1fr)); }", css)
