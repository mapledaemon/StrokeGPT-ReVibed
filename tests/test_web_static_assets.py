...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn("#chat-compose-row { grid-template-columns: var(--composer-min-height) minmax(0, 1fr); }", css)
            self.assertIn("#voice-control-buttons { grid-column: 1; width: var(--composer-min-height); }", css)
