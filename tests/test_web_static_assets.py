...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="start-voice-input-btn" class="my-button voice-control-button" title="Voice input backend not implemented yet" aria-disabled="true" disabled', page)
            self.assertIn('id="stop-voice-input-btn" class="my-button voice-control-button" title="Voice input backend not implemented yet" aria-disabled="true" disabled', page)
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn("#voice-control-buttons { min-height: var(--composer-min-height);", css)
            self.assertIn("grid-template-columns: repeat(2, minmax(4rem, auto));", css)
            self.assertIn(".voice-control-button { width: auto; min-width: 4rem;", css)
