...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".message-content { grid-column: 2; display: flex; flex-direction: column; min-width: 0; max-width: min(100%, var(--chat-message-max-width));", css)
