...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn("#motion-status-strip:has(.motion-diagnostics-panel:not([hidden])) { height: auto; max-height: none; }", css)
            ...
            self.assertIn("border: 1px solid #2d333d; overflow: hidden; display: flex; flex-direction: column; justify-content: center;", css)
            self.assertIn("#motion-status-strip:has(.motion-diagnostics-panel:not([hidden])) #visualizer-box { height: auto; max-height: none; min-height: var(--motion-strip-height); justify-content: flex-start; }", css)
            ...
            self.assertIn("#motion-status-strip:has(.motion-diagnostics-panel:not([hidden])) .motion-sequence-log { height: 100%; max-height: none; }", css)
            ...
            self.assertIn(".motion-diagnostics-panel { margin-top: 4px; min-height: 1.65rem;", css)
            self.assertIn("overflow: visible; overflow-wrap: anywhere; white-space: normal;", css)
