...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertLess(page.index('id="sidebar-handy-panel"'), page.index('id="handy-cylinder-indicator"'))
            self.assertLess(page.index('id="handy-cylinder-indicator"'), page.index('class="sidebar-stop-section"'))
