...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="top-bar-voice-toggle-btn" class="my-button top-bar-voice-toggle" type="button" title="Turn voice output on" aria-label="Voice output off" aria-pressed="false" data-requires-backend>Voice Off</button>', page)
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".top-bar-actions .top-bar-voice-toggle { width: auto; min-width: 5.75rem;", css)
            self.assertIn(".top-bar-actions .top-bar-voice-toggle.is-on { border-color: rgba(127, 183, 163, 0.7);", css)
            ...
            self.assertIn(".prompt-mode-controls, .prompt-refresh-row { grid-template-columns: 1fr; }", css)
            ...
            self.assertIn(".settings-tabs { grid-template-columns: repeat(2, minmax(0, 1fr)); }", css)
