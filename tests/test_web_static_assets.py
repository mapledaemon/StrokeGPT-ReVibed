...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="top-bar-bluetooth-menu" class="top-bar-bluetooth-menu"', page)
            self.assertIn('id="top-bar-bluetooth-btn" class="my-button top-bar-toggle-button top-bar-bluetooth-toggle" type="button" title="Show local Handy Bluetooth status" aria-label="Handy Bluetooth disconnected" aria-pressed="false" aria-haspopup="dialog" aria-controls="top-bar-bluetooth-popover" aria-expanded="false"', page)
            self.assertIn('class="bluetooth-button-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"', page)
            self.assertIn('d="m7 7 10 10-5 5V2l5 5L7 17"', page)
            self.assertIn('id="top-bar-bluetooth-popover" class="top-bar-bluetooth-popover" role="dialog" aria-label="Handy Bluetooth status" hidden', page)
    ...
    def test_settings_dialog_contains_device_and_speed_controls(self):
        ...
        try:
            ...
            self.assertIn('Use pattern library playback in Freestyle', page)
            self.assertIn('Let normal chat choose pattern library moves', page)
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".top-bar-actions .top-bar-bluetooth-toggle { width: var(--top-bar-button-size); min-width: var(--top-bar-button-size);", css)
            self.assertIn(".bluetooth-button-icon { width: 1.22rem; height: 1.22rem;", css)
            self.assertIn(".top-bar-actions .top-bar-bluetooth-toggle.is-on { border-color: rgba(127, 183, 163, 0.72);", css)
            self.assertIn(".top-bar-bluetooth-popover { position: absolute;", css)
