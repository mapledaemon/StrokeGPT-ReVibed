...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="top-bar-bluetooth-btn" class="my-button top-bar-toggle-button top-bar-bluetooth-toggle" type="button" title="Show local Handy Bluetooth status" aria-label="Handy Bluetooth disconnected" aria-pressed="false" aria-haspopup="dialog" aria-controls="top-bar-bluetooth-popover" aria-expanded="false">BT Off</button>', page)
