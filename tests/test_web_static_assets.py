...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('id="open-settings-btn" class="profile-menu-item" type="button" role="menuitem" data-settings-target="persona"', page)
            self.assertIn('id="profile-picture-menu-btn" class="profile-menu-item" type="button" role="menuitem"', page)
