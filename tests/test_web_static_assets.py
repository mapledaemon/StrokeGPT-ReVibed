...
class WebStaticAssetTests(WebTestCase):
    ...
    def test_root_links_frontend_assets(self):
        ...
        try:
            ...
            self.assertIn('class="handy-bluetooth-label">Local Bluetooth</span>', page)
    ...
    def test_frontend_css_contains_responsive_layout_guards(self):
        ...
        try:
            ...
            self.assertIn(".handy-bluetooth-menu { position: relative; display: grid;", css)
            self.assertIn(".handy-bluetooth-toggle { flex: 0 0 2.25rem; width: 2.25rem;", css)
            self.assertIn(".bluetooth-button-icon { width: 1.45rem; min-width: 1.45rem; height: 1.45rem;", css)
            self.assertIn(".handy-bluetooth-toggle.is-on { border-color: rgba(127, 183, 163, 0.72);", css)
            self.assertIn(".handy-bluetooth-popover { padding: var(--space-2);", css)
