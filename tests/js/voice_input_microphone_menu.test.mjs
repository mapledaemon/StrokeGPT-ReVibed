...
describe('voice input microphone menu', () => {
    ...
    beforeEach(async () => {
        [
            ...
            'voice-input-hands-free-freestyle-checkbox',
            'voice-input-hands-free-edging-checkbox',
            'voice-input-hands-free-milking-checkbox',
            'voice-input-hands-free-legacy-auto-checkbox',
